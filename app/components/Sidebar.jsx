  ...
  return (
    <div className="sidebar w-[240px] h-screen bg-[#FFFFFF]  ">
      <h3 className="text-center font-extrabold  font-Nunito text-xl ml-[66px] mt-6 mr-[53.36px]">
        <span className="text-[#4880FF] font-Nunito ">Dash</span>Stack
      </h3>
      <Link to="/">
        {" "}
        <div className="mt-[30px] px-6 ">
          <div
            ...
            }  py-4  p-4    rounded-md items-center font-Nunito gap-3`}
          >
            <svg
              width="22"
              height="25"
      ...
      <div className="px-6 ">
        ...
        <div
            className={`flex${
              isActive("/DashboardPage") ? " bg-[#4880FF] text-white" : ""
            }  py-4  p-4 rounded-md items-center font-Nunito gap-3`}
          >
            <svg
              width="22"
            ...
            >
              <path
                ...
                fill="black" className={`flex   ${
                  isActive("/DashboardPage") ? " fill-white" : "fill-black"
                } `}
              />
            </svg>
      ...
      <div className="px-6">
        ...
        <div
            className={`flex${
              isActive("/Favoritespage") ? " bg-[#4880FF] text-white" : ""
            }  py-4  p-4 rounded-md items-center font-Nunito gap-3`}
          >
            <svg
              width="22"
            ...
            >
              <path
                ...
                fill="black"
                className={`flex   ${
                  isActive("/Favoritespage") ? " fill-white" : "fill-black"
                } `}
              />
            </svg>
      ...
      <div className="px-6">
        ...
        <div
            className={`flex${
              isActive("/inboxpage") ? " bg-[#4880FF] text-white" : ""
            }  py-4  p-4 rounded-md items-center font-Nunito gap-3`} >
            <svg
              width="22"
              height="22"
            ...
            >
              <path
                ...
                fill="black"
                className={`flex   ${
                  isActive("/inboxpage") ? " fill-white" : "fill-black"
                } `}
              />
            </svg>
      ...
      <div className="px-6">
        ...
        <div
            className={`flex${
              isActive("/Orderlistpage") ? " bg-[#4880FF] text-white" : ""
            }  py-4  p-4 rounded-md items-center font-Nunito gap-3`} >
            <svg
              width="22"
              height="22"
            ...
            >
              <path
                ...
                fill="black"
                className={`flex   ${
                  isActive("/Orderlistpage") ? " fill-white" : "fill-black"
                } `}
              />
            </svg>
      ...
      <div className="px-6">
        ...
        <div
            className={`flex${
              isActive("/Productlistpage") ? " bg-[#4880FF] text-white" : ""
            }  py-4  p-4 rounded-md items-center font-Nunito gap-3`} >
            <svg
              width="22"
              height="22"
            ...
            >
              <path
                ...
                fill="black"
                className={`flex   ${
                  isActive("/Productlistpage") ? " fill-white" : "fill-black"
                } `}
              />
            </svg>
      ...
      <div className="text-[#202224] text-sm py-4 pl-10 ">PAGES</div>
      <div className="px-6">
      ...
      <div className="px-6">
        ...
        <div
            className={`flex${
              isActive("/Calenderpage") ? " bg-[#4880FF] text-white" : ""
            }  py-4  p-4 rounded-md items-center font-Nunito gap-3`} >
            <svg
              width="22"
              height="22"
            ...
            >
              <path
                ...
                fill="black"
                className={`flex   ${
                  isActive("/Calenderpage") ? " fill-white" : "fill-black"
                } `}
              />
            </svg>
            <p
      ...
      <div className="px-6">
        <Link to="/Todopage">
          ...
          <div
            className={`flex${
              isActive("/Todopage") ? " bg-[#4880FF] text-white" : ""
            }  py-4  p-4 rounded-md items-center font-Nunito gap-3`} >
            <svg
              width="22"
              height="22"
            ...
            >
              <path
                ...
                fill="#202224"
                className={`flex   ${
                  isActive("/Todopage") ? " fill-white" : "fill-black"
                } `}
              />
            </svg>
      ...
      <div className="px-6">
        ...
        <div
            className={`flex${
              isActive("/Contectpage") ? " bg-[#4880FF] text-white" : ""
            }  py-4  p-4 rounded-md items-center font-Nunito gap-3`} >
            <svg
              width="22"
              height="22"
            ...
            >
              <path
                ...
                fill="#202224"
                className={`flex   ${
                  isActive("/Contectpage") ? " fill-white" : "fill-black"
                } `}
              />
            </svg>
      ...
      <div className="px-6">
        ...
        <div
            className={`flex${
              isActive("/Invoicepage") ? " bg-[#4880FF] text-white" : ""
            }  py-4  p-4 rounded-md items-center font-Nunito gap-3`} >
          <svg
            width="22"
            height="22"
          ...
          >
            <path
              ...
              fill="black"
              className={`flex   ${
                isActive("/Invoicepage") ? " fill-white" : "fill-black"
              } `}
            />
          </svg>
